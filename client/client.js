        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.post('http://34.80.24.2:3000/generate-proof', input, {
                            headers: {
                ...
                case 1:
                    ...
                    if (response.data.success) {
                        console.log("Proof generated successfully in ".concat(response.data.timeElapsed, " seconds"));
